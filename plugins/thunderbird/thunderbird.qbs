...
Product {
    ...
    Probe {
        ...
        configure: {
            ...
            process.exec("lupdate", ["-verbose", "-no-recursive", "plugins/thunderbird", "-ts", "plugins/thunderbird/langs/lang_ru_RU.ts"]);
    ...
    Group {
        ...
        qbs.install: true
        qbs.installDir: "./plugins/thunderbird"
    }
    Group {
        name: "QML resources"
    ...
    Group {
        ...
        fileTagsFilter: "qm"
        qbs.install: true
        qbs.installDir: "./plugins/thunderbird/langs"
    }
}
